...
export function OnboardingGoalPage() {
  ...
  return (
    <main
      ...
      className="relative mx-auto flex min-h-[100svh] w-full max-w-[var(--page-max-width)] flex-col items-center overflow-x-hidden bg-[#faf9fc] font-['42dot_Sans','Hanken_Grotesk','Noto_Sans_KR',sans-serif]"
    >
      <SiteTopBar
        title="집중이담"
      ...
      <section className="flex w-full flex-col items-start px-5 pb-8 pt-8">
