...
export function StarterFavoritesPage() {
  ...
  return (
    <main className="relative isolate mx-auto flex min-h-[100svh] w-full max-w-[390px] flex-col overflow-hidden bg-[#faf9fc] pb-[156px] font-['42dot_Sans','Hanken_Grotesk','Noto_Sans_KR',sans-serif]">
      ...
      <div className="fixed bottom-20 left-1/2 z-[2] flex w-full max-w-[390px] -translate-x-1/2 bg-gradient-to-t from-[#faf9fc] via-[#faf9fc] to-[#faf9fc00] px-5 pb-6 pt-6">
        <Link
          href="/starter/time"
      ...
      <StarterFavoritesBottomNav />
    </main>
  );
}

function StarterFavoritesBottomNav() {
  const items = [
    { label: "홈", icon: Home, href: "/", active: false },
    { label: "기록", icon: CalendarDays, href: "/starter/new", active: false },
    { label: "타이머", icon: Timer, href: "/focus/current", active: true },
