import { Banknote, Heart, MessageSquare, Zap } from 'lucide-react';
        ...
        {QUICK_START_ITEMS.map((item) => {
          ...
          return (
            <button
              type="button"
              key={item.title}
              className="flex min-h-[118px] flex-col items-start rounded-[32px] border-0 bg-[#f4f3f6e6] p-5 text-left transition hover:-translate-y-0.5 hover:bg-[var(--color-surface-container)] focus-visible:outline focus-visible:outline-4 focus-visible:outline-offset-2 focus-visible:outline-[#3c5f7c40]"
            >
              <span
