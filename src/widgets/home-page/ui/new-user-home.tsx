      ...
      <section id="new-user-main-hero" className="flex gap-8 flex-col">
        ...
        <SiteCard>
          ...
          <SiteButton
            href="/starter/new"
            variant="primary"
            className="mt-4 w-full !min-h-12 !border-0 !bg-[#466d8d] !text-sm !font-medium !shadow-[0_4px_8px_rgba(60,95,124,0.2)] hover:!bg-[var(--color-primary)]"
          >
            첫 스타터 만들기
          </SiteButton>
          <div className="my-4 h-px bg-[#c2c7ce47]" />
          <RecommendedAction />
        </SiteCard>
      </section>
