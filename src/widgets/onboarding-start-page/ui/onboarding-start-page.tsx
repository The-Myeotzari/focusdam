...
export function OnboardingStartPage() {
  return (
    <main
      ...
      className="relative isolate mx-auto flex min-h-[100svh] w-full max-w-[var(--page-max-width)] flex-col items-center overflow-hidden bg-[#faf9fc] font-['42dot_Sans','Hanken_Grotesk','Noto_Sans_KR',sans-serif]"
    >
